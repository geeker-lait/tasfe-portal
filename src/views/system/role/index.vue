...
<div class="app-container">
    <div class="filter-container">
        ...
        <el-input @keyup.enter.native="handleFilter" style="width: 150px; margin-left: 10px;" class="filter-item" :placeholder="$t('system.role.name')" v-model="listQuery.name" />
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" border fit highlight-current-row style="width: 100%;min-height:100%;">
        ...
        <!--角色名-->
        <el-table-column align="center" :label="$t('system.role.name')" width="120">
            <template slot-scope="scope">
                <span>{{scope.row.name}}</span>
            </template>
        </el-table-column>
        <!-- 描述 -->
        <el-table-column align="center" :label="$t('system.role.descr')" width="120">
            <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :rules="rules" ref="dataForm" :model="temp" label-position="left" label-width="70px" style='width: 400px; margin-left:50px;'>
            <!-- <el-form-item :label="$t('system.root.icon')" prop="icon">
                <el-input v-model="temp.icon"></el-input>
            </el-form-item> -->
            <el-form-item :label="$t('system.role.name')">
                <el-input v-model="temp.name"></el-input>
            </el-form-item>
            <el-form-item :label="$t('system.role.descr')">
